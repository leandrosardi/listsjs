listsJs = {
    ...
    get_list_id: function(parent) {
        // get the .div-export-lists inside the parent element
        let div = $(parent).find('.div-export-lists');
        return $(div).attr('data-id-lead');
    },

    set_list_id: function(parent, id) {
        // get the .div-export-lists inside the parent element
        let div = $(parent).find('.div-export-lists');
        $(div).attr('data-id-lead', id);
    },
        ...
        li.addEventListener('click', function(e) {
            ...
            if ( $(this).attr('data-belonging') === 'true' || $(this).attr('data-belonging') === true ) {
                ...
                if (listsJs.events[parent.id+".on_uncheck_item"]) {
                    // call the function
                    listsJs.events[parent.id+".on_uncheck_item"](h);                        
                } else {
                ...
                if (listsJs.events[parent.id+".on_check_item"]) {
                    // call the function
                    listsJs.events[parent.id+".on_check_item"](h);
                } else {
...
/*
    set_item_id: function(parent, id, new_id) {
        // get the .div-export-lists inside the parent element
        let div = $(parent).find('.div-export-lists');
        let li = $(div).find('li[data-id-export-list="'+id+'"]');
        $(li).attr('data-id-export-list', new_id);
    },
*/
    /*
    ...
    */
    ...
    add_item_from_input: function(parent) {
        ...
        if (listsJs.events[parent.id+".on_add_item"]) {
            // call the function
            listsJs.events[parent.id+".on_add_item"](h);
        } else {
